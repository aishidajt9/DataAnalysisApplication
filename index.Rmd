...
14. 【コアウィークス⑪】分析実習(1)：実習データを元に回帰分析をRで実行する．その際，自ら計算する場合と組み込み関数を使う場合を比較し，出力の読み方を学習する．
15. 【コアウィークス⑫】分析実習(2)：ひきつづき実習データを元にロジスティック回帰分析をRで実行する．その際，自ら計算する場合と組み込み関数を使う場合を比較し，出力の読み方を学習する．
