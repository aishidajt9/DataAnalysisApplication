...
高度な統計手法，データサイエンスの方法をさらに学ぶためには，線形代数の知識が必須になる．本章では初歩レベルのベクトルの知識と計算方法を導入し，**内積と直交**を理解することを目標とする．第6章で最小二乗法を扱う際に，「残差が説明変数と直交するように係数を選ぶ」という形でこの概念が効いてくる．

なお「（参考）」を付した節は授業では扱わない．理解の助けになる内容なので，興味のある者は各自読んでおくとよい．
...
ここは本章のなかでもっとも重要な箇所である．第6章で最小二乗法の意味を理解する際に用いる．
...
## （参考）共分散と相関係数のベクトルによる理解

> **この節は授業では扱わない．** 内容は第2章「記述統計の復習」で扱った共分散・相関係数を，ベクトルの内積として捉え直したものである．興味のある者は読んでおくとよい．
